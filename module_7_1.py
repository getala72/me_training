...
class Shop:
    def __init__(self):
        self.__file_name = r'C:\Users\Pc\Desktop\site\products.txt'
    ...
    def add(self, *products):
        ...
        for product in products:
            ...
            if product_str not in existing_products_set:
                new_products.append(product_str)
                existing_products_set.add(product_str)
            else:
