    ...
    def deposit(self): 
        for i in range(100):
            if self.balance >= 500 and self.lock.locked():
                self.lock.release()
            v=random.randint(50,500)

            self.balance+=v
            print(f"Пополнение: {v}. Баланс: {self.balance}")
            time.sleep(0.001)
...
# Далее производится проверка: если случайное число меньше или равно текущему балансу, то произвести снятие, уменьшив balance на соответствующее число и вывести на 
# экран "Снятие: <случайное число>. Баланс: <текущий баланс>".
